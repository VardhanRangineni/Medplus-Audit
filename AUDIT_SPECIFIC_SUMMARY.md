# Audit-Specific Summary Documentation
...
Not applicable - this summary focuses on re-audit and auditor details rather than KPIs.
...
- See **SUPERVISOR_SUMMARY.md** for supervisor oversight context
- See **AUDITOR_SUMMARY.md** for individual auditor performance tracking
- See **USER_GUIDE.md** for complete dashboard navigation
- See **NESTED_DRILLDOWN_GUIDE.md** for detailed drill-down functionality
- See **FUNCTIONAL_SPECIFICATION.md** (Section 3.5) for technical specifications
